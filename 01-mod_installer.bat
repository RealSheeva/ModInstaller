...
echo Note: If you are already happy with your forge version, you can close the forge installer
echo Please ensure your forge version is forge-1.12.2-14.23.5.2836 or higher for compatibility!
echo . 
echo .
echo .
...
del /f "%appdata%\.minecraft\mods\1.12.2\*"
